                        ...
                        <div class="p-0" data-simplebar style="max-height: 580px;">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <button type="button" class="dropdown-item" href=""
                                                            id="choose-file-button">change profile picture</button>
                            ...
                            <div class="p-4 pt-0">
                                ...
                                <div class="mt-n5 position-relative text-center border-bottom pb-3">
                                    ...
                                    <img src="{{ Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : URL::asset('build/images/users/avatar-3.jpg') }}"
                        ...
                        <div class="card" style="min-height: 500px;max-height: 500px;">
                            <div class="card-body">
                                <div class="mx-n3 px-3" data-simplebar style="max-height: 580px;">
                                    ...
                                    <div class="mt-3">
                                        <p class="font-size-15 mb-1">Hi my name is
                                        ...
                                        <tr>
                                            <td>
                                                <h5 class="font-size-14 m-0">
                                                    <a href="javascript:void(0);"
                                                        onclick="showSkillInfo({{ $skill }})" class="text-body">
                                                        {{ $skill->name }}
                                                    </a>
                                                </h5>
                                            </td>
                                            <td>
                                                <div>
                                                    @switch(strtolower($skill->experience))
                                                        @case('beginner')
                                                            <span
                                                                class="badge bg-danger   font-size-13">{{ $skill->experience }}</span>
                                                        @break

                                                        @case('intermediate')
                                                            <span
                                                                class="badge bg-warning  font-size-13">{{ $skill->experience }}</span>
                                                        @break

                                                        @case('expert')
                                                            <span
                                                                class="badge bg-success   font-size-13">{{ $skill->experience }}</span>
                                                        @break

                                                        @default
                                                            <span
                                                                class="badge bg-secondary-subtle font-size-14">{{ $skill->experience }}</span>
                                                    @endswitch
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p><strong>Portfolio URL:</strong> <a id="skillPortfolioUrl" href="#" target="_blank">Skill
                                Portfolio</a></p>
