                                ...
                                <table class="table align-middle table-nowrap mb-1">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-body">Daniel
                                                        Canales</a></h5>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-body">Carl
                                                        Mackay</a></h5>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            <td><img src="{{ URL::asset('build/images/users/avatar-4.jpg') }}"
                                                    class="rounded-circle avatar-sm" alt=""></td>
                                            <td>
                                                <h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-body">Janice
                                                        Cole</a></h5>
                                            </td>
                                            <td>
                                                <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="font-size-14 m-0"><a href="javascript: void(0);" class="text-body">Tony
                                                        Brafford</a></h5>
                                            </td>
                                            <td>
                                                <div>
