            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="user-profile-img">
                        <img src="{{ URL::asset('build/images/coming-soon.png') }}"
                            ...
                            <div class="row text-center">
                                <div class="col-12 border-end">
                                    ...
                                    <div class="p-1 mt-4">
                                        ...
                                        <h3 class="mb-2 fw-bold font-size-14">Type : <span class="text-muted ""> {{$event->type}}</span></h3>
                                        <h3 class=" mb-2 fw-bold font-size-14">End In : <span class="text-muted ">
                                                    {{$event->end_date}}</span></h3>
                            ...
                            <div class="timeline">
                                <div class="timeline-container">
                                            ...
                                            <div class="col-md-6">
                                                <div class="timeline-box">
                                                    <div class="timeline-date bg-primary text-center rounded">
                                                        <h3 class="text-white mb-0 font-size-20">{{ \Carbon\Carbon::parse($time->start_time)->format('d') }}</h3>
                                                        <p class="mb-0 text-white-50">{{ \Carbon\Carbon::parse($time->start_time)->format('F') }}</p>
                                                    </div>
                                                    <div class="event-content">
                                                        <div class="timeline-text">
                                                            <h3 class="font-size-17">{{$time->title}}</h3>
                                                            <p class="mb-0 mt-2 pt-1 text-muted">{{$time->description}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="timeline-box">
                                                    ...
                                                    <div class="event-content">
                                                        <div class="timeline-text">
                                                            <h3 class="font-size-17">{{$time->title}}</h3>
                                                            <p class="mb-0 mt-2 pt-1 text-muted">{{$time->description}}
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="timeline-launch">
                                        <div class="timeline-box">
                                            <div class="timeline-text">
                                                <h3 class="font-size-17">Launched our eveny on {{$event->start_date}} to {{$event->start_date}}</h3>
                            ...
                            <div class="">
                                ...
                                <div class="text-muted mb-3">
                                    <span class="badge bg-success font-size-14 me-1"><i class="mdi mdi-star"></i>
                                        {{$event->averageRating ? number_format($event->average_rating, 1) : 'Not reviewed yet'}}</span> {{$event->reviews->count()}} Reviews
                                </div>
                                    ...
                                    <div class="px-4 mt-2">
                                        <form action="{{ route('event_reviews.store',$event->id) }}" method="POST"
                                            ...
                                            <div class="border rounded mt-4">
                                                ...
                                                <!-- Rate.js Rating -->
                                                <div id="rating" data-rate-value="{{ $userReview ? $userReview->rating : 5 }}">
                                                </div>
                                            ...
                                            <div class="text-end mt-3">
                                                @if ($userReview)
                                                <button type="submit" form="reviewForm" class="btn btn-warning w-sm text-truncate ms-2">
                                                    Update Review <i class="bx bx-refresh ms-2 align-middle"></i>
                                                </button>
                                                @else
                                                <button type="submit" form="reviewForm" class="btn btn-success w-sm text-truncate ms-2">
