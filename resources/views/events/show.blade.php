                ...
                <div class="card">
                    <div class="card-body p-0">
                        <div class="user-profile-img">
                            <img src="{{ URL::asset('storage/' .$event->visualIdentity->banner_url) }}"
                        ...
                        <div class="my-3 pt-1 text-center">
                            ...
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <a href="{{ route('events.categories.name', $item->name) }}" class="btn btn-success  fw-bold font-size-14">
                                        {{ $item->name }}
                                    </a>
                                </li>
                                @endforeach
                            </ul>
                            <h5 class="my-3">Domains :</h5>
                            <ul class="list-inline mb-0">
                            ...
                            <div class="col-12">
                                <div class="">
                                    ...
                                    <div class="border py-4 rounded">
                                        ...
                                        <div class="px-4 mt-2">
                                            <form action="{{ route('event_reviews.store', $event->id) }}" method="POST" id="reviewForm">
                                                @csrf
                                                <div class="border rounded mt-4">
                                                    ...
                                                    @else
                                                    <textarea rows="3" class="form-control border-0 resize-none"
                                                        placeholder="Your Message..." name="review_message"></textarea>
                                                    @endif
