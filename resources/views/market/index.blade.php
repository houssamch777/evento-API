                    ...
                    <div class="card-body">
                        <div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div>
                                        <h5>Showing result for "Skills & Assets"</h5>
                                        <!--
                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="product-box rounded p-3 mt-4">
                                                ...
                                                <div class="product-img bg-light p-3 rounded">
                                                    <img src="{{ $skill->user->profile_picture ? asset('storage/' . $skill->user->profile_picture) : URL::asset('build/images/users/avatar-3.jpg') }}"
                                                        alt="" class="img-fluid mx-auto d-block">
                                                </div>
                                                <div class="product-content pt-3">
                                                    <p class="text-muted font-size-13 mb-0">{{$skill->user->first_name.' '.$skill->user->last_name}}</p>
                                                    <h5 class="mt-1 mb-0"><a href="#"
                                                            class="text-body font-size-16">{{$skill->name}}</a></h5>
                                                    ...
                                                    <h5 class="font-size-14 text-primary mt-3 mb-0">{{$skill->cost.' dz .'.$skill->cost_type}}
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
